      ...
      <Tabs value={ActiveTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="edit">
          <form className="space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font font-medium">Professional Summary</h3>
              <Controller
                name="summary"
                control={control}
                render={({ field }) => {
            ...
            <div className="space-y-4">
              <h3 className="text-lg font font-medium">Skills</h3>
              <Controller
                name="skills"
                control={control}
                render={({ field }) => {
            ...
            <div className="space-y-4">
              <h3 className="text-lg font font-medium">Work Experience</h3>
              <Controller
                name="experience"
                control={control}
                render={({ field }) => {
            ...
            <div className="space-y-4">
              <h3 className="text-lg font font-medium">Education</h3>
              <Controller
                name="education"
                control={control}
                render={({ field }) => {
            ...
            <div className="space-y-4">
              <h3 className="text-lg font font-medium">Projects</h3>
              <Controller
                name="projects"
                control={control}
                render={({ field }) => {
