-- CreateEnum
CREATE TYPE "public"."DemandLevelEnum" AS ENUM ('High', 'Medium', 'Low');

-- CreateEnum
CREATE TYPE "public"."MarketOutlookEnum" AS ENUM ('Positive', 'Neutral', 'Negative');
...
CREATE TABLE "public"."IndustryInsight" (
    ...
    "demandLevel" "public"."DemandLevelEnum" NOT NULL,
    "topSkills" TEXT[],
    "marketOutlook" "public"."MarketOutlookEnum" NOT NULL,
    "keyTrends" TEXT[],
